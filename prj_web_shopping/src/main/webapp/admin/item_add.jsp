...
<form action="item_add_process.jsp" id="frm" name="frm" method="post"  enctype="multipart/form-data" style="position:relative; left:30px" >
		...
		<div id="background_box" style="width: 1200px; height:750px; font-family:  pretendard; margin-left: -70px ; margin-top: -30px"> <!-- 각자 원하는데로 사용 -->
																									<input type="text" id="goodsName" name="goodsName"   style="position: absolute; top: 43px; left: 90px; height: 30px; width:260px" value="내용을 입력해주세요">
		<label style="position: absolute; top: 40px; left: 20px; font-size: 20px">상품명 : </label><!-- <textarea  id="goodsName" name="goodsName"  style="position: absolute; top: 43px; left: 90px; height: 30px; width:260px" >내용을 입력해주세요</textarea> -->
																												<input type="text" id="goodsCode" name="goodsCode"  style="position: absolute; top: 43px; left: 470px; height: 30px; width:150px" value="내용을 입력해주세요">
		...
		<textarea id="tmi" name="tmi" style="border: 1px solid #333; width: 630px ; height: 185px; position: relative; top: 140px; left: 20px ">한글 정보를 입력해주세요</textarea>
		
		<textarea id="engTmi" name="engTmi" style="border: 1px solid #333; width: 630px ; height: 185px; position: absolute; top: 340px; left: 20px  ">영어 정보를 입력해주세요</textarea>
		
		
		<div id="note"style="border: 0px solid #333; width: 630px ; height: 130px; position: relative; top: 340px; left: 20px">
			<label style="margin-left: 20px">topnote</label><br><textarea id="top" name="top" style="border: 1px solid #333; margin-left: 20px; height: 80px"></textarea>
				<label style="position: absolute; top: 0px; left: 220px" >heart</label><textarea id="heart" name="heart" style="border: 1px solid #333; height: 80px; position: absolute; top: 23px; left: 220px" ></textarea>
					<label style="position: absolute; top: 0px; left: 420px">base</label><br><textarea id="base" name="base"  style="border: 1px solid #333; height: 80px;  position: absolute; top: 23px; left: 420px"></textarea>
		</div>
		...
		<input type="file" id="mainImg" name="mainImg"  class="inputBox" style="position: absolute; top: 140px; left: 800px;">
	 ...
	 <input type="file" id="img1" name="img1"  class="inputBox" style="position: absolute; top: 190px; left: 800px;">
	 ...
	 <label  style="position: absolute; top: 240px; left: 700px; ">image2 : </label>
		<input type="file" id="img2" name="img2"  class="inputBox" style="position: absolute; top: 240px; left: 800px;">
	 
		<label  style="position: absolute; top: 290px; left: 700px; ">image3 : </label>
		<input type="file" id="img3" name="img3"  class="inputBox" style="position: absolute; top: 290px; left: 800px;">
		...
		<input type="file" id="detailImg" name="detailImg"  class="inputBox" style="position: absolute; top: 340px; left: 800px;">
		 
		<button type="button" class="n-btn btn-accent" id="btnAdd" style="position: absolute; top: 680px; left:1050px;  width:120px; height: 50px">등록</button>
		
		<div  style="position: absolute; top: 430px; left: 700px; border: 0px solid #333; width: 200px; height: 50px; font-size: 20px"><label>가격: </label>  <input type="text" id="price" name="price" style="width: 120px; heigth: 25px;" value=""/></div>
		<div  style="position: absolute; top: 485px; left:700px; border: 0px solid #333; width: 200px; height: 50px; font-size: 20px"><label>수량: </label>  <input type="text" id="quantity" name="quantity" style="width: 120px; heigth: 25px; " value=""/></div>
		<label style="position: absolute; top: 550px; left:700px;" >ingredient : </label><textarea id="ing" name="ing" style="width: 300px ; height: 80px ; position: absolute; top: 550px; left:790px"></textarea>
