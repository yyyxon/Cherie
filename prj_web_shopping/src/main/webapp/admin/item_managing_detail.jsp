...
%>
	...
	<div id="rightBody" style="height: 895px">
		...
		<div id="background_box" style="width: 1550px; height:750px; font-family: pretendard; position:relative; margin-left: -90px; top:55px"> <!-- 각자 원하는데로 사용 -->
	
		<label style="position: absolute; top: 20px; left: 20px; font-size: 20px">상품명 : </label><textarea  id="goodsName" name="goodsName"  style="position: absolute; top: 23px; left: 90px; height: 30px; width:260px; border-width: 0 0 1px;"  placeholder="추가 정보를 입력해주세요" ><c:out value="${product.goodsName eq 'null' ? '' : product.goodsName}" /></textarea>
		
		<label style="position: absolute; top: 20px; left: 380px; font-size: 20px">상품코드 : </label><textarea id="goodsCode" name="goodsCode" style="position: absolute; top: 23px; left: 470px; height: 30px; width:150px;  border-width: 0 0 1px;"><%=gcode %></textarea>
		<label style="position: absolute; top: 80px; left: 20px; font-size: 20px">상세정보</label>
		<!-- <div id="tmi" style="border: 1px solid #333; width: 630px ; height: 370px; position: relative; top: 140px; left: 20px  "></div> -->
		<textarea id="tmi" name="tmi" style="border: 1px solid #333; width: 630px ; height: 185px; position: relative; top: 120px; left: 20px "><%=pVO.getTmi() %></textarea>
		...
		<div id="note"style="border: 0px solid #333; width: 630px ; height: 130px; position: relative; top: 340px; left: 20px">
			<label style="margin-left: 20px">top note</label><br><textarea id="top" name="top" style="border: 1px solid #333; margin-left: 20px; height: 80px"  placeholder="추가 정보를 입력해주세요"><c:out value="${product.top eq 'null' ? '' : product.top}" /></textarea>
		...
		<div style="position: absolute; top: 40px; left: 680px; width: 400px; height: 400px"><img id="previewMainImg"  src="../upload/goods/${product.mainImg eq null ? 'img_null.png' : product.mainImg}" style="width:400px ;height:400px ;" id="mainImg__div" name="mainImg__div"></div>
		<input type="file" id="mainImg" name="mainImg"  class="inputBox" style="position: absolute; top: 460px; left: 680px;">
		<div  style="position: absolute; top: 40px; left: 1100px; width: 160px; height: 160px"><img id="previewImg1" name="previewImg1"  src="../upload/goods/${product.img1 eq null ? 'img_null.png' : product.img1}" style="width:160px ;height:160px"></div>
	 <input type="file" id="img1" name="img1"  class="inputBox" style="position: absolute; top: 210px; left: 1100px;">
		
	 <div style="position: absolute; top: 40px; left: 1320px; width: 50px; height: 160px"><img id="previewImg2"  src="../upload/goods/${product.img2 eq null ? 'img_null.png': product.img2}" style="width:160px ;height:160px"></div>
		<input type="file" id="img2" name="img2"  class="inputBox" style="position: absolute; top: 210px; left: 1320px; width: 200px">
	 
		<div style="position: absolute; top: 280px; left: 1100px; width: 160px; height: 160px"><img id="previewImg3" src="../upload/goods/${product.img3 eq null ? 'img_null.png' : product.img3}" style="width:160px ;height:160px"></div>
		<input type="file" id="img3" name="img3"  class="inputBox" style="position: absolute; top: 460px; left: 1100px;">
		
		<div style="position: absolute; top: 280px; left: 1320px; width: 50px; height: 160px"><img id="previewDetailImg"  src="../upload/goods/${product.detailImg eq null ? 'img_null.png' : product.detailImg }" style="width:160px ;height:160px"></div>
		<input type="file" id="detailImg" name="detailImg"  class="inputBox" style="position: absolute; top: 460px; left: 1320px; width: 200px">
		 
		<button type="button" class="btnCss" id="btnImgSubmit" name="btnImgSubmit" style="position: absolute; top: 550px; left:1320px;  width:120px; height: 50px">이미지 업로드</button>
		<button type="button" class="btnCss" id="btnUpdate" style="position: absolute; top: 550px; left:1150px;  width:120px; height: 50px">수정</button>
		...
		<button type="button" class="btnCss" id="btnDelete" name="btnDelete" style="position: absolute; top: 620px; left:1150px;  width:120px; height: 50px">삭제</button>
